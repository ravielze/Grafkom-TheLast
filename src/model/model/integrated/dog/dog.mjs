...
export class Cow {
    ...
    buildSkeleton() {
        ...
        this.jointPoints = {
            ...
            'ear-left': [this.centers['ear-left'][0], this.centers['ear-left'][1] - earSize[1] / 2, this.centers['head'][2] + headSize[2] / 2],
            'ear-right': [this.centers['ear-right'][0], this.centers['ear-right'][1] - earSize[1] / 2, this.centers['head'][2] + headSize[2] / 2],
