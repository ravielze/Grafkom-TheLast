...
export class Human extends Model {
    ...
    private humanTime: number = 0;

    constructor(private webGL: WebGL, private readonly control: Control) {
        super();

        this.control.animation.addAnimationHandler((val: number) => {
            this.humanTime += (val * 0.1) % 360;
            this.distributeRotation(30 * Math.sin(this.humanTime));
        ...
        const kScaleBody = [
            bodyShape[0] / cubeSize,
            bodyShape[1] / cubeSize,
            bodyShape[2] / cubeSize,
        ];
        const kScaleHead = [
            headShape[0] / cubeSize,
            headShape[1] / cubeSize,
            headShape[2] / cubeSize,
        ];
        const kScaleHand1 = [
            handLeftShape[0] / cubeSize,
            handLeftShape[1] / cubeSize,
            handLeftShape[2] / cubeSize,
        ];
        const kScaleHand2 = [
            handRightShape[0] / cubeSize,
            handRightShape[1] / cubeSize,
            handRightShape[2] / cubeSize,
        ];
        ...
        const hand1 = CubeOperation.scale(CUBE_POSITIONS, {
            x: kScaleHand1[0],
            y: kScaleHand1[1],
            z: kScaleHand1[2],
        });
        const hand2 = CubeOperation.scale(CUBE_POSITIONS, {
            x: kScaleHand2[0],
            y: kScaleHand2[1],
            z: kScaleHand2[2],
        });
        ...
        this.skeletons = {
            ...
            hand1: CubeOperation.translate(hand1, {
                x: this.centers['hand1'][0],
                y: this.centers['hand1'][1],
                z: this.centers['hand1'][2],
            }),
            hand2: CubeOperation.translate(hand2, {
                x: this.centers['hand2'][0],
                y: this.centers['hand2'][1],
                z: this.centers['hand2'][2],
            }),
        };
    ...
    updateAnimation() {
        this.root!.L!.baseTransform = DefaultMatrix.rotate(
            {
                x: this.inRotation['head']['x'],
                y: this.inRotation['head']['y'],
                z: this.inRotation['head']['z'],
            },
            { x: 0, y: 0, z: 0 }
        );
        this.root!.L!.R!.baseTransform = DefaultMatrix.rotate(
            {
                x: this.inRotation['hand1']['x'],
                y: this.inRotation['hand1']['y'],
                z: this.inRotation['hand1']['z'],
            },
            {
        ...
        this.root!.L!.R!.R!.baseTransform = DefaultMatrix.rotate(
            {
                x: this.inRotation['hand2']['x'],
                y: this.inRotation['hand2']['y'],
                z: this.inRotation['hand2']['z'],
            },
            {
        ...
        this.root!.L!.R!.R!.R!.baseTransform = DefaultMatrix.rotate(
            {
                x: this.inRotation['leg-front-left']['x'],
                y: this.inRotation['leg-front-left']['y'],
                z: this.inRotation['leg-front-left']['z'],
            },
            {
        ...
        this.root!.L!.R!.R!.R!.R!.baseTransform = DefaultMatrix.rotate(
            {
                x: this.inRotation['leg-front-right']['x'],
                y: this.inRotation['leg-front-right']['y'],
                z: this.inRotation['leg-front-right']['z'],
            },
            {
